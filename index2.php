...
<body class="home">
        ...
        <!-- banner part starts -->
        <section class="hero bg-image" data-image-src="images/img/mainImage.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    <h1>Place Order & Take-It </h1>
                    <h5 class="font-white space-xs">Find best food for you</h5>
                    ...
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4><span>1. </span>Choose Your Food</h4> </div>
                        <!-- end:Step -->
                        ...
                        <div class="step-item step3">
                            ...
                            <h4><span>3. </span>Pick Up Order</h4> </div>
                        <!-- end:Step -->
                    </div>
                    <!-- end:Steps -->
                </div>
