  		...
  		<div class="container">
  			<div class="footers20-content">
  				<div class="d-grid grid-col-4 grids-content">
  					<div class="column">
  						<h4>Address</h4>
  						<p class="contact-para3">Malnad College of Engineering, Hassan.</p>
  						
  					</div>
  					<div class="column">
  						<h4>contact Us</h4>
  						<a href="tel:02642 246 402">
  							<p class="contact-phone mt-2">Subramanya T N - 0123456789</p>
							  <p class="contact-phone mt-2">Yashas D R - 0123456789</p>
  						</a>
  					</div>
  					<div class="column">
  						<h4>Opening hours</h4>
